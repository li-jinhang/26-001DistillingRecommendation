...
class MADC(GeneralRecommender):
    def __init__(self, config, dataset):
        super(MADC, self).__init__(config, dataset)
    ...
    def calculate_alignment_loss(self, users):
        ...
        # 2. 针对用户交互过的全部物品进行 Max Pooling
        # 利用 scatter_max 沿用户维度聚合对应物品的特征 (返回值是一个元组，[0]是结果，[1]是 argmax 索引)
